...
export const ButtonControl: FunctionComponent<ComponentProps<'button'>> = ({
  ...
  const classes = [
    'min-h-[42px] rounded-[8px] inline-flex items-center border border-gray-300 bg-gray-100 p-2 text-xs text-gray-500 shadow-transparent transition-all duration-300',
